...
interface IndexConfig {
  ...
  bodyMaxLength: number; // Max body character length for instruction entries (default 20000)
...
function parseIndexConfig(): IndexConfig {
  ...
  const bodyMaxLength = clamp(numberFromEnv('INDEX_SERVER_BODY_MAX_LENGTH', DEFAULT_LIMITS.BODY_MAX_LENGTH), DEFAULT_LIMITS.BODY_MIN_LENGTH, DEFAULT_LIMITS.BODY_ABS_MAX_LENGTH);
  return {
