...
## The 6-Layer Hook Model

| Layer | Protection                  | Hook Phase  | Key Script / Tool               |
|-------|-----------------------------|-------------|----------------------------------|
| 1     | Forbidden file blocking     | pre-commit  | `scripts/pre-commit.ps1`        |
| 2     | Curated PII scanning        | pre-commit  | `.pii-allowlist`, detect-secrets |
| 3     | Live env-value leak scan    | pre-commit  | `scripts/pre-commit.ps1`        |
| 4     | Standard secret scanners    | pre-commit  | detect-secrets baseline          |
| 5     | Protected-remote enforcement| pre-push    | `scripts/pre-push.ps1`          |
| 6     | CI replay of local policy   | CI workflow  | `.github/workflows/ci.yml`      |
