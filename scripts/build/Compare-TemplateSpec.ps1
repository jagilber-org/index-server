...
$fileDefinitions = @(
    ...
    @{ TemplatePath = 'scripts/Invoke-ReleaseWorkflow.ps1'; Strategy = 'MergeReview'; Reason = 'Canonical release/publish front door that orchestrates preflight, internal push/check verification, clean-room preparation, and human-only mirror handoff.' }
    ...
    @{ TemplatePath = 'scripts/publish-direct-to-remote.cjs'; Strategy = 'MergeReview'; Reason = 'Compatibility entrypoint for direct mirror publication workflows.' }
