...
| `INDEX_SERVER_BODY_MAX_LENGTH` | 20000 | runtime | Max body character length for instruction entries. Range: 1000-1000000. |
...
| `INDEX_SERVER_ADMIN_API_KEY` | (none) | runtime | Admin API key for dashboard. |
