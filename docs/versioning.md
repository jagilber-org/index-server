...
`scripts/Publish-ToPublicRepo.ps1` remains available for manual review-oriented publication flows:

- `-DryRun` to inspect what would be published
- local clean-copy review
...
The legacy dual-repo PowerShell publisher has been removed. Do not reintroduce it unless the repository intentionally adopts a second supported release implementation.
