...
> Index Server — Enterprise instruction indexing platform for AI assistant governance. Aligned to the layered hook security template v1.31.0 (constitution v2.9.0).
...
---
*Generated by sync-constitution.cjs from constitution.json v2.10.0*
