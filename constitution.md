...
> Index Server — Enterprise instruction indexing platform for AI assistant governance. Aligned to the layered hook security template constitution v2.7.0.
...
---
*Generated by sync-constitution.cjs from constitution.json v2.7.0*
